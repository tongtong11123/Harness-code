...
flowchart TD
  ...
  Sink --> File[".harness-code/sessions/&lt;session&gt;/trace.jsonl"]
  ...
  ErrSink --> ErrFile[".harness-code/sessions/&lt;session&gt;/errors.jsonl"]
```
...
- trace：`{workspace}/.harness-code/sessions/<session_id>/trace.jsonl`
- error log：`{workspace}/.harness-code/sessions/<session_id>/errors.jsonl`
